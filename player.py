...
Button(root, image = ButtonPlay, bg ="#FFFFFF", bd = 0, height = 60, command = PlayMusic).place(x=215, y = 487)
...
Button(root, text = "Choose your own music", width = 59, height = 1, font = ("calibri", 12, "bold"), fg="Black", bg = "#FFFFFF", command = AddMusic).place(x=0,y=550)
